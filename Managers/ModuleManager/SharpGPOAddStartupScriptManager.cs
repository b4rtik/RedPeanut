...
namespace RedPeanut
{
    class SharpGPOAddStartupScriptManager : IMenu
    {
        ...
        string modulename = "gpoaddstartupscript";
        ...
        public SharpGPOAddStartupScriptManager() {

        }

        public SharpGPOAddStartupScriptManager(IAgentInstance agent)
        {
            this.agent = agent;
        }
