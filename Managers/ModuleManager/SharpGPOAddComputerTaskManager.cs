...
namespace RedPeanut
{
    class SharpGPOAddComputerTaskManager : IMenu
    {
        ...
        string modulename = "addcomputertask";
        ...
        public SharpGPOAddComputerTaskManager()
        {

        }

        public SharpGPOAddComputerTaskManager(IAgentInstance agent)
        {
            this.agent = agent;
        }
