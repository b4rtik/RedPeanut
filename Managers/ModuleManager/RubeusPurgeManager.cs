...
namespace RedPeanut
{
    class RubeusPurgeManager : IMenu
    {
        ...
        string modulename = "purge";
        string luid;

        public RubeusPurgeManager()
        {

        }

        public RubeusPurgeManager(IAgentInstance agent)
        {
            this.agent = agent;
        }
        ...
        public void Execute()
        {
            ...
            do
            {
                ...
                RubeusPurgeMenu(input);
            } while (input != "back");
        }

        private void RubeusPurgeMenu(string input)
        {
