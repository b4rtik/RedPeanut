...
namespace RedPeanut
{
    class RubeusPttManager : IMenu
    {
        ...
        string modulename = "ptt";
        string luid;
        string ticket;

        public RubeusPttManager()
        {

        }

        public RubeusPttManager(IAgentInstance agent)
        {
            this.agent = agent;
        }
        ...
        private void RubeusPttMenu(string input)
        {
