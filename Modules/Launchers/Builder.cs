...
namespace RedPeanut
{
    public class Builder
    {
        ...
        static CSharpCompilation CreateCompilation(string filesrcasstr, string destfilename, IEnumerable<MetadataReference> references, string type = "dll", bool isAgent = false)
        {
            ...
            if (isAgent && sourceDirectory != null)
            {
        ...
        public static byte[] BuidStreamAssembly(string filesrcasstr, string destfilename, int targetFramework, string type = "dll", bool isAgent = false)
        {
            
            CSharpCompilation compilation = CreateCompilation(filesrcasstr, destfilename, GetReferences(targetFramework), type, isAgent);
            try
            {
